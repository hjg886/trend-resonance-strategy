...
UNIVERSE = {
    ...
    # 2026-08-21 精准回滚（R-08期望转负裁决）: 剔除 IS/OOS 双负标的 —— 510300沪深300/588000科创50/512880证券/512690酒
...
UNIVERSE_R9 = {
    ...
    # "510500": ("etf_510500", "中证500ETF", "etf_wide", None),  # 精准回滚: 双负
    ...
    # "515050": ("etf_515050", "5G通信ETF", "etf_ind", "通信"),  # 精准回滚: 双负
